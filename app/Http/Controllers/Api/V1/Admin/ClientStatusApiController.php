<?php
/**
 * FILE ClientStatusApiController.php
 *
...
class ClientStatusApiController extends Controller
{
    ...
    public function store(StoreClientStatusRequest $request)
    {
        ...
        return (new ClientStatusResource($clientStatus))->response()->setStatusCode(Response::HTTP_CREATED);
    }
    ...
    public function update(UpdateClientStatusRequest $request, ClientStatus $clientStatus)
    {
        ...
        return (new ClientStatusResource($clientStatus))->response()->setStatusCode(Response::HTTP_ACCEPTED);
    }
